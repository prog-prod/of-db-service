                ...
                <tag title="${(tagData.title || tagData.email)}"
                    ...
                    <div class="d-flex align-items-center">
                        <div class='tagify__tag__avatar-wrap ps-0'>
                            <img onerror="this.style.visibility='hidden'" class="rounded-circle w-25px me-2" src="${hostUrl}admin-panel/media/${tagData.avatar}">
                        </div>
                ...
                <div ${this.getAttributes(tagData)}
                    ...
                    ${tagData.avatar ? `
                            <div class='tagify__dropdown__item__avatar-wrap me-2'>
                                <img onerror="this.style.visibility='hidden'"  class="rounded-circle w-50px me-2" src="${hostUrl}admin-panel/media/${tagData.avatar}">
                            </div>` : ''
                }
