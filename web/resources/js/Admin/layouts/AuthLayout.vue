<template>
  ...
  <div class="d-flex flex-column flex-lg-row flex-column-fluid min-vh-100">
    ...
    <div
      ...
      style="background-image: url('/admin-panel/media/misc/auth-bg.png')"
    >
      <!--begin::Content-->
      <div
      ...
      >
        ...
        <Link href="/" class="mb-0 mb-lg-12">
          <img
            alt="Logo"
            src="/admin-panel/media/logos/custom-1.png"
        ...
        <img
          ...
          :src="getAssetPath('/admin-panel/media/misc/auth-screens.png')"
          alt=""
        />
        <!--end::Image-->
